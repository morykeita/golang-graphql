...
func (ec *executionContext) field_Mutation_createMeetup_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewMeetup2githubᚗcomᚋmorykeitaᚋgraphqlᚑgolangᚐNewMeetup(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNNewMeetup2githubᚗcomᚋmorykeitaᚋgraphqlᚑgolangᚐNewMeetup(ctx context.Context, v interface{}) (NewMeetup, error) {
